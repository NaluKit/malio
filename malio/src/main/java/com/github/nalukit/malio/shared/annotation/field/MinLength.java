...
/**
 * <p>The annotation accepts a int value of the minimal numbers of characters. This is the
 * minimal length allowed for the variable - if the value is not null. </p>
 *
