...
/**
 * This annotation is used to annotate a field inside a POJO. It tells malio to look for a mailo vlaidator
 * and use this validator to validate the field. * * @author Frank Hossfeld, Philipp Kohl
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.FIELD)
public @interface UseMalioValidator {
}