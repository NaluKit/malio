...
import io.github.nalukit.malio.model.notnull01.Address;
import io.github.nalukit.malio.model.notnull01.Person;
import io.github.nalukit.malio.model.notnull01.PersonMalioValidator;
...
public class ValidatorNotNull01Test
  ...
  public void testValidateFail01() {
    ...
    ErrorMessage errorMessage = result.getMessages()
                                      .get(0);
    assertEquals("io.github.nalukit.malio.model.notnull01.Person",
  ...
  public void testValidateFail03() {
    ...
    ErrorMessage errorMessage01 = result.getMessages()
                                        .get(0);
    assertEquals("io.github.nalukit.malio.model.notnull01.Address",
                 errorMessage01.getClassname());
