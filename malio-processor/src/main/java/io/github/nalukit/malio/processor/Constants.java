...
public class Constants {
  public final static String MALIO_CONSTRAINT_ARRAY_ITEM_MAX_LENGTH_IMPL_NAME      = "MalioConstraintArrayItemMaxLength";
  public final static String MALIO_CONSTRAINT_ARRAY_ITEM_MIN_LENGTH_IMPL_NAME      = "MalioConstraintArrayItemMinLength";
  public final static String MALIO_CONSTRAINT_ARRAY_ITEM_NOT_BLANK_IMPL_NAME       = "MalioConstraintArrayItemNotBlank";
  public final static String MALIO_CONSTRAINT_ARRAY_ITEM_NOT_NULL_IMPL_NAME        = "MalioConstraintArrayItemNotNull";
  public final static String MALIO_CONSTRAINT_COLLECTION_ITEM_MAX_LENGTH_IMPL_NAME = "MalioConstraintCollectionIteMaxLength";
  public final static String MALIO_CONSTRAINT_COLLECTION_ITEM_MIN_LENGTH_IMPL_NAME = "MalioConstraintCollectionIteMinLength";
  public final static String MALIO_CONSTRAINT_COLLECTION_ITEM_NOT_BLANK_IMPL_NAME  = "MalioConstraintCollectionItemNotBlank";
  public final static String MALIO_CONSTRAINT_COLLECTION_ITEM_NOT_NULL_IMPL_NAME   = "MalioConstraintCollectionItemNotNull";
