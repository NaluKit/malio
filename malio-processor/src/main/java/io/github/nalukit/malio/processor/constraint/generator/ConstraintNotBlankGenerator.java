...
public class ConstraintNotBlankGenerator
  ...
  private final AbstractProcessorConstraint<NotBlank> constraint;
  ...
  public static class Builder {
    ...
    AbstractProcessorConstraint<NotBlank> constraint;
    ...
    public Builder constraint(AbstractProcessorConstraint<NotBlank> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintNotBlankGenerator build() {
      return new ConstraintNotBlankGenerator(this);
    }
  }
}
