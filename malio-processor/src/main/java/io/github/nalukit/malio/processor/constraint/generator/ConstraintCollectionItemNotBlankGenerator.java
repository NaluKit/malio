...
public class ConstraintCollectionItemNotBlankGenerator
    extends AbstractGenerator {

  private final AbstractProcessorConstraint<CollectionItemNotBlank> constraint;

  private ConstraintCollectionItemNotBlankGenerator(Builder builder) {
  ...
  public static class Builder {
    ...
    AbstractProcessorConstraint<CollectionItemNotBlank> constraint;
    ...
    public Builder constraint(AbstractProcessorConstraint<CollectionItemNotBlank> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintCollectionItemNotBlankGenerator build() {
      return new ConstraintCollectionItemNotBlankGenerator(this);
    }
  }
}
