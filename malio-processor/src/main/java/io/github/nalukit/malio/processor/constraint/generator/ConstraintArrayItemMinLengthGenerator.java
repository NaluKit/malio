...
public class ConstraintArrayItemMinLengthGenerator
    extends AbstractGenerator {

  private final AbstractProcessorConstraint<ArrayItemMinLength> constraint;

  private ConstraintArrayItemMinLengthGenerator(Builder builder) {
  ...
  protected CodeBlock generate(Element clazz,
    ...
    return CodeBlock.builder()
                    .add("new $T($S, $S, $S, $L, $S)" + suffix,
                         ...
                         field.getSimpleName()
                              .toString(),
                         field.getAnnotation(ArrayItemMinLength.class)
                              .value(),
  ...
  public static class Builder {
    ...
    AbstractProcessorConstraint<ArrayItemMinLength> constraint;
    ...
    public Builder constraint(AbstractProcessorConstraint<ArrayItemMinLength> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintArrayItemMinLengthGenerator build() {
      return new ConstraintArrayItemMinLengthGenerator(this);
    }
  }
}
