...
public class ConstraintArrayItemNotNullGenerator
    extends AbstractGenerator {
  private final AbstractProcessorConstraint<ArrayItemNotNull> constraint;

  private ConstraintArrayItemNotNullGenerator(Builder builder) {
  ...
  public static class Builder {
    ...
    AbstractProcessorConstraint<ArrayItemNotNull> constraint;
    ...
    public Builder constraint(AbstractProcessorConstraint<ArrayItemNotNull> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintArrayItemNotNullGenerator build() {
      return new ConstraintArrayItemNotNullGenerator(this);
    }
  }
}
