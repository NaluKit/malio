...
import io.github.nalukit.malio.processor.constraint.generator.ConstraintUuidGenerator;
import io.github.nalukit.malio.processor.model.ConstraintType;
import io.github.nalukit.malio.shared.annotation.field.Uuid;
import io.github.nalukit.malio.shared.internal.constraint.UuidConstraint;
...
public class UuidProcessorConstraint
    extends AbstractProcessorConstraint<Uuid> {

  public UuidProcessorConstraint() {
  }
  ...
  public TypeName getValidationClass(VariableElement variableElement) {
    return ClassName.get(UuidConstraint.class);
  }
