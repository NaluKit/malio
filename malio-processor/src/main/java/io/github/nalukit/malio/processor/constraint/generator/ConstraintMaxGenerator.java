...
public class ConstraintMaxGenerator
  ...
  public static class Builder {
    ...
    AbstractProcessorConstraint<Max> constraint;
    ...
    public Builder constraint(AbstractProcessorConstraint<Max> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintMaxGenerator build() {
      return new ConstraintMaxGenerator(this);
    }
  }
}
