...
public class ConstraintArrayItemNotBlankGenerator
    extends AbstractGenerator {

  private final AbstractProcessorConstraint<ArrayItemNotBlank> constraint;

  private ConstraintArrayItemNotBlankGenerator(Builder builder) {
  ...
  public static class Builder {
    ...
    AbstractProcessorConstraint<ArrayItemNotBlank> constraint;
    ...
    public Builder constraint(AbstractProcessorConstraint<ArrayItemNotBlank> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintArrayItemNotBlankGenerator build() {
      return new ConstraintArrayItemNotBlankGenerator(this);
    }
  }
}
