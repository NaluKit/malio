...
public class ConstraintMinDecimalValueGenerator
    ...
    typeSpec.addMethod(MethodSpec.constructorBuilder()
                                 ...
                                 .addStatement("super($S, $S, $S, $S)",
                                               ...
                                               variableElement.getSimpleName()
                                                              .toString(),
                                               variableElement.getAnnotation(constraint.annotationType())
                                                              .value())
  ...
  public static class Builder {
    ...
    public Builder constraint(AbstractConstraint<DecimalMinValue> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintMinDecimalValueGenerator build() {
      return new ConstraintMinDecimalValueGenerator(this);
    }
  }
}
