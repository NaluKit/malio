...
public class ProcessorUtils {
    ...
    public String createStringInitializationFromArray(String[] array) {
        ...
        for (int i = 0; i < array.length; i++) {
            newArray[i] = String.format("\"%s\"", array[i]);
        }
        return String.format("new String[]{%s}", String.join(", ", newArray));
    }
    ...
    public boolean checkPrimitiveDataType(VariableElement variableElement, TypeKind... typeKind) {
