...
import com.github.nalukit.malio.processor.constraints.generator.ConstraintMaxGenerator;
...
public class MaxConstraint
    extends AbstractConstraint<Max> {

  public MaxConstraint(ProcessingEnvironment processingEnv,
