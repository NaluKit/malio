...
public class ConstraintCollectionItemMinLengthGenerator
    extends AbstractGenerator {
  private final AbstractProcessorConstraint<CollectionItemMinLength> constraint;

  private ConstraintCollectionItemMinLengthGenerator(Builder builder) {
  ...
  protected CodeBlock generate(Element clazz,
    ...
    return CodeBlock.builder()
                    .add("new $T($S, $S, $S, $L, $S)" + suffix,
                         ...
                         field.getSimpleName()
                              .toString(),
                         field.getAnnotation(CollectionItemMinLength.class)
                              .value(),
                         field.getAnnotation(CollectionItemMinLength.class)
                              .message(),
  ...
  public static class Builder {
    ...
    AbstractProcessorConstraint<CollectionItemMinLength> constraint;
    ...
    public Builder constraint(AbstractProcessorConstraint<CollectionItemMinLength> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintCollectionItemMinLengthGenerator build() {
      return new ConstraintCollectionItemMinLengthGenerator(this);
    }
  }
}
