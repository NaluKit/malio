...
public class ConstraintMaxDecimalGenerator
  ...
  private AbstractConstraint<DecimalMax> constraint;
  ...
  public static class Builder {
    ...
    AbstractConstraint<DecimalMax> constraint;
    ...
    public Builder constraint(AbstractConstraint<DecimalMax> constraint) {
