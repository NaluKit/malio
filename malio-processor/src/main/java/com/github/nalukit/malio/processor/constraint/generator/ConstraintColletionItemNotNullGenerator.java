...
public class ConstraintColletionItemNotNullGenerator
  ...
  public static class Builder {
    ...
    public Builder constraint(AbstractProcessorConstraint<CollectionItemNotNull> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintColletionItemNotNullGenerator build() {
      return new ConstraintColletionItemNotNullGenerator(this);
    }
  }
}
