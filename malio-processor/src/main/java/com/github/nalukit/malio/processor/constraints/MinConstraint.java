...
import com.github.nalukit.malio.processor.constraints.generator.ConstraintMinGenerator;
...
public class MinConstraint
    extends AbstractConstraint<Min> {

  public MinConstraint(ProcessingEnvironment processingEnv,
