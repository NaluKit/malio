...
public class ConstraintBlacklistGenerator
  ...
  public static class Builder {
    ...
    public Builder constraint(AbstractProcessorConstraint<Blacklist> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintBlacklistGenerator build() {
      return new ConstraintBlacklistGenerator(this);
    }
  }
}
