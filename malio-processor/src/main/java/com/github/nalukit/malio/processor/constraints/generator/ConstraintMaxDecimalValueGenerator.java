...
public class ConstraintMaxDecimalValueGenerator
    extends AbstractGenerator {

  private AbstractConstraint<DecimalMaxValue> constraint;
  private ConstraintMaxDecimalValueGenerator(Builder builder) {
    ...
    typeSpec.addMethod(MethodSpec.constructorBuilder()
                                 ...
                                 .addStatement("super($S, $S, $S, $S)",
                                               ...
                                               variableElement.getSimpleName()
                                                              .toString(),
                                               variableElement.getAnnotation(DecimalMaxValue.class)
                                                              .value())
  ...
  public static class Builder {
    ...
    AbstractConstraint<DecimalMaxValue> constraint;
    ...
    public Builder constraint(AbstractConstraint<DecimalMaxValue> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintMaxDecimalValueGenerator build() {
      return new ConstraintMaxDecimalValueGenerator(this);
    }
  }
}
