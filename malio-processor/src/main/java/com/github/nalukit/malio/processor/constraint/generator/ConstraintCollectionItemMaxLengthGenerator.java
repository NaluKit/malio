...
public class ConstraintCollectionItemMaxLengthGenerator
    extends AbstractGenerator {
  private final AbstractProcessorConstraint<CollectionItemMaxLength> constraint;

  private ConstraintCollectionItemMaxLengthGenerator(Builder builder) {
  ...
  protected CodeBlock generate(Element clazz,
    ...
    return CodeBlock.builder()
                    .add("new $T($S, $S, $S, $L, $S)" + suffix,
                         ...
                         field.getSimpleName()
                              .toString(),
                         field.getAnnotation(CollectionItemMaxLength.class)
                              .value(),
                         field.getAnnotation(CollectionItemMaxLength.class)
                              .message(),
  ...
  public static class Builder {
    ...
    AbstractProcessorConstraint<CollectionItemMaxLength> constraint;
    ...
    public Builder constraint(AbstractProcessorConstraint<CollectionItemMaxLength> constraint) {
      this.constraint = constraint;
      return this;
    }

    public ConstraintCollectionItemMaxLengthGenerator build() {
      return new ConstraintCollectionItemMaxLengthGenerator(this);
    }
  }
}
