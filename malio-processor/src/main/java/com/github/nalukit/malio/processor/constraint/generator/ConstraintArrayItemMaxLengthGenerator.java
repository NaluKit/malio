...
public class ConstraintArrayItemMaxLengthGenerator
  ...
  protected CodeBlock generate(Element clazz,
    ...
    return CodeBlock.builder()
                    .add("new $T($S, $S, $S, $L, $S)" + suffix,
                         ...
                         field.getSimpleName()
                              .toString(),
                         field.getAnnotation(ArrayItemMaxLength.class)
                              .value(),
                         field.getAnnotation(ArrayItemMaxLength.class)
                              .message(),
  ...
  public static class Builder {
    ...
    public ConstraintArrayItemMaxLengthGenerator build() {
      return new ConstraintArrayItemMaxLengthGenerator(this);
    }
  }
}
