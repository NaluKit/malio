...
public class ConstraintMinValueScanner
    extends AbstractScanner {

  private final TypeElement     validatorElement;
  private final VariableElement variableElement;

  private ConstraintMinValueScanner(Builder builder) {
  ...
  public ConstraintModel createConstraintModel() {
    return new ConstraintModel(this.processorUtils.getPackageAsString(this.validatorElement),
                               ...
                               Constants.MALIO_CONSTRAINT_MINVALUE_IMPL_NAME,
                               ConstraintType.MIN_VALUE_CONSTRAINT);
  }
  ...
  public static class Builder {
    ...
    public ConstraintMinValueScanner build() {
      return new ConstraintMinValueScanner(this);
    }
  }
}
