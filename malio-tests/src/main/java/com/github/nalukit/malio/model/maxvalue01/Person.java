 ...
 */
package com.github.nalukit.malio.model.maxvalue01;
...
public class Person {
  ...
  @MaxValue(99) private int age;

  @MaxValue(99) private long numberChildren;

  @MaxValue(123) private Integer complexTypeTest;
